SELECT ff.Manufacturer_Part_number as sku,'Laptops' as attribute_set, 'simple' as type,ic.ProductTitle as name,
 ...
 'New' as `condition`,
 ic.Supplier as manufacturer, ic.Model as model, 'Laptop' as notebook_type,ic.Processor_family as processor, ic.Processor_frequency as processor_speed,
 ...
 ic.Number_of_battery_cells as battery_size, TRUNCATE(replace(ic.Weight,' kg','')*2.20462,2) as weight,
 '1 Year Warranty' as warranty, TRUNCATE(ff.Contract_Price_With_Promo_Rebate*1.2,2) as price, 'Catalogue/Laptops' as categories,
